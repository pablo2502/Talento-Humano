...
/**
 * Manejador global de excepciones: traduce excepciones de negocio/validacion
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleBadCredentials(BadCredentialsException ex) {
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                .body(ApiError.of(HttpStatus.UNAUTHORIZED.value(), "INVALID_CREDENTIALS", "Correo o contrasena invalidos"));
    }

    @ExceptionHandler(AccessDeniedException.class)
    public ResponseEntity<ApiError> handleAccessDenied(AccessDeniedException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiError.of(HttpStatus.FORBIDDEN.value(), "ACCESS_DENIED", "No tiene permisos para esta operacion"));
    }
    ...
    public ResponseEntity<ApiError> handleValidation(MethodArgumentNotValidException ex) {
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ApiError.of(HttpStatus.BAD_REQUEST.value(), "VALIDATION_ERROR", "Datos invalidos", detalles));
    }
